...
function CreateUnitsForPlayer1()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("Hmkg"), -4722.9, 3551.4, 256.099, FourCC("Hmkg"))
    u = BlzCreateUnitWithSkin(p, FourCC("Hmkg"), -3885.3, 3091.5, 245.684, FourCC("Hmkg"))
end
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ncop"), -4224.0, 3968.0, 270.000, FourCC("ncop"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncop"), -2304.0, 5888.0, 270.000, FourCC("ncop"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncop"), -384.0, 7808.0, 270.000, FourCC("ncop"))
end
...
function CreateRegions()
    local we
    gg_rct_Region_000 = Rect(-5056.0, 2784.0, -4576.0, 3264.0)
end
...
function main()
    local we
    SetCameraBounds(-5504.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 2304.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 1408.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 9984.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -5504.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 9984.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 1408.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 2304.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
    SetDayNightModels("Environment\\DNC\\DNCLordaeron\\DNCLordaeronTerrain\\DNCLordaeronTerrain.mdl", "Environment\\DNC\\DNCLordaeron\\DNCLordaeronUnit\\DNCLordaeronUnit.mdl")
    SetTerrainFogEx(0, 0.0, 5000.0, 0.500, 0.502, 0.502, 0.502)
    we = AddWeatherEffect(Rect(-6144.0, 2048.0, 2048.0, 10240.0), FourCC("RAlr"))
